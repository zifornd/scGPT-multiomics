...
# TODO: implement load_model function, also check the flash-attn install in the function
# TODO: apply to all applications
# TODO: test in different pytorch versions
def load_pretrained(
